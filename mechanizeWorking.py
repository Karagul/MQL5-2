...
sign_in = br.open("https://www.myanonamouse.net/login.php?returnto=%2F")
...
br["email"] = "samuelsonsev@gmail.com" #the key "username" is the variable that takes the username/email value
...
req = br.open("https://www.myanonamouse.net/tor/browse.php?tor%5BbrowseStart%5D=true").read()
